...
SDLGameObject::SDLGameObject(const LoadParams *pParams) : GameObject(pParams),
	m_position(pParams->getX(), pParams->getY()), m_width(pParams->getWidth()),
...
void SDLGameObject::draw()
{
	if (m_velocity.getX() > 0) {
		TextureManager::Instance()->drawFrame(m_textureID, (int)m_position.getX(), (int)m_position.getY(), m_width, m_height, m_currentRow,
