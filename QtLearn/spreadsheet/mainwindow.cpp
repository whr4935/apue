	...
	: QMainWindow(parent)
{
	...
	setWindowIcon(QIcon(":/spreadsheet/icon"));
	setCurrentFile("");
}
...
void MainWindow::sort()
{
	...
	if (dialog.exec()) {
		...
		compare.keys[0] =
			dialog.firstColumnComboBox->currentIndex();
		compare.keys[1] =
			dialog.secondColumnComboBox->currentIndex() - 1;
		compare.keys[2] =
			dialog.thirdColumnComboBox->currentIndex() - 1;
		compare.ascending[0] =
			(dialog.firstOrderComboBox->currentIndex() == 0);
		compare.ascending[1] =
			(dialog.secondOrderComboBox->currentIndex() == 0);
		compare.ascending[2] =
			(dialog.thirdOrderComboBox->currentIndex() == 0);
...
void MainWindow::createActions()
{
	...
	newAction->setIcon(QIcon(":/spreadsheet/new"));
	newAction->setShortcut(QKeySequence::New);
	newAction->setStatusTip(tr("Create a new spreadsheet file"));
	connect(newAction, SIGNAL(triggered()), this, SLOT(newFile()));

	openAction = new QAction(tr("&Open..."), this);
	openAction->setIcon(QIcon(":/spreadsheet/open"));
	openAction->setShortcut(QKeySequence::Open);
	openAction->setStatusTip(tr("Open an existing spreadsheet file"));
	connect(openAction, SIGNAL(triggered()), this, SLOT(open()));

	saveAction = new QAction(tr("&Save"), this);
	saveAction->setIcon(QIcon(":/spreadsheet/save"));
	...
	cutAction->setIcon(QIcon(":/spreadsheet/cut"));
	...
	copyAction->setIcon(QIcon(":/spreadsheet/copy"));
	...
	pasteAction->setIcon(QIcon(":/spreadsheet/paste"));
	...
	findAction->setIcon(QIcon(":/spreadsheet/find"));
	findAction->setShortcut(QKeySequence::Find);
	findAction->setStatusTip(tr("Find a matching cell"));
	connect(findAction, SIGNAL(triggered()), this, SLOT(find()));

	goToCellAction = new QAction(tr("&Go to Cell..."), this);
	goToCellAction->setIcon(QIcon(":/spreadsheet/gotocell"));
	...
	showGridAction->setStatusTip(tr("Show or hide the spreadsheet's "
		"grid"));
    //下面只能用toggled信号，因为调用setChecked不会发送triggered信号
