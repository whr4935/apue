...
using GMap2 = std::map<std::string, std::function<int(int argc, char* argv[])>>;
static GMap2& getGroutineMap2()
{
    static GMap2 g2;
    return g2;
}
...
{
    auto ret = getGroutineMap2().emplace(name, routine);
