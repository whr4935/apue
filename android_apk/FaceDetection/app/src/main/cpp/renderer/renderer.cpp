...
int Renderer::packCameraBuffer()
{
    ...
    if (mTexBuffer != NULL) {
        ...
        if ((err = glGetError()) == GL_NO_ERROR) {
            // mFaceDetection->sendFrame((uint8_t*)mTexBuffer, 0ll, mTexBuffer);
        } else {
...
static void Java_com_liantong_renderer_renderer_native_init(JNIEnv* env)
{
    ...
    clazz = env->FindClass("com/example/whr/facedetection/Renderer");
    if (clazz == NULL) {
...
static void Java_com_liantong_renderer_renderer_native_setup(JNIEnv* env, jobject thiz, jobject surface, jobject surfaceTexture)
{
...
static JNINativeMethod gMethods[] = {
        ...
        {"native_setup",
                "(Landroid/view/Surface;Landroid/view/Surface;)V",
...
static void Java_com_liantong_renderer_rendererHelper_native_init(JNIEnv* env)
{
    ...
    clazz = env->FindClass("com/example/whr/facedetection/RendererHelper");
    if (clazz == NULL) {
